...
public @interface FieldsValueMatch {
    ...
    Class<? extends Payload>[] payload() default {}; //specifies additional metadata that can be attached to a constraint

    //    The field() method specifies the name of the field to be validated.
    String field();

    //The fieldMatch() method specifies the name of the field whose value should match the field() value.
    String fieldMatch();
    ...
    @interface List {
        ...
        //  allows for the specification of multiple instances of the FieldsValueMatch annotation.
        //  This is useful when a class has multiple fields that need to be validated against each other.
    }
