...
//        List<Categories> sortedCategories = categoryService.findAll(Sort.by("categoryName"));
        model.addAttribute("category", categories);
        model.addAttribute("page", categoryService.getCategoryByKeyword(currentPage.orElse(0), pageSize.orElse(10), keyword.orElse("%")));
    ...
    public String createCate(Model model, RedirectAttributes redirectAttributes, @RequestParam("cateId") Optional<String> cateId, @RequestParam("categoryName") String categoryName) {
        ...
        if (categories != null) {
            redirectAttributes.addFlashAttribute("message", "The category Name : " + categoryName + " had been existed!");
            return "redirect:/admin/category";
        }
    ...
    public String updateCate(Model model, RedirectAttributes redirectAttributes, @RequestParam("cateId") Optional<Integer> cateId, @RequestParam("categoryName") String categoryName) {
