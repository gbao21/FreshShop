...
public class CartController {
    ...
    public String displayCartPage(Model model) {
        ...
        System.out.println(cartImp.getCount());
    ...
    public ResponseEntity<Map<String, Object>> addToCart(Model model,
        ...
        if (customer == null) {
            return ResponseEntity.badRequest().body(Collections.singletonMap("error", messageSource.getMessage("pleaseLogin", null, LocaleContextHolder.getLocale())));
        }
